export const formsTranslations: Record<string, Record<string, string>> = {
  en: {
    ...
    'forms.a11y.drop-zone': 'File drop zone',
    'forms.a11y.remove-file': 'Remove {{name}}',
    'forms.a11y.preview-file': 'Preview {{name}}',
    'forms.a11y.show-password': 'Show password',
    'forms.a11y.hide-password': 'Hide password',
    'GENERAL.SAVE': `Save`,
  ...
  nl: {
    ...
    'form.field.add_new': 'Nieuw toevoegen',
    'forms.select-field.selectAllLabel': `Selecteer alles`,
    'forms.a11y.drop-zone': 'Zone om bestanden neer te zetten',
    'forms.a11y.remove-file': '{{name}} verwijderen',
    'forms.a11y.preview-file': '{{name}} bekijken',
    'forms.a11y.show-password': 'Wachtwoord tonen',
    'forms.a11y.hide-password': 'Wachtwoord verbergen',
